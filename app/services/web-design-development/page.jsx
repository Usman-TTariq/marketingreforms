  ...
  return (
    <>
      ...
      <HeroSection
        ...
        firstIcon={true}
        secondIcon={false}
        paragraph="Pitch your brand with the most immersive websites and easy-to-use web interfaces."
        paraClassName="pt-4"
      ...
      <div className="relative pt-12 overflow-hidden">
        ...
        <div className="container relative z-20 px-4">
          <div className="max-w-4xl mx-auto">
            <div className="text-white text-[20px] text-center max-lg:text-[18px] max-md:text-[16px] max-sm:text-[14px] font-satoshi leading-relaxed">
              <p>
                Be the first ones to enjoy
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="container relative z-20 px-4">
          <div className="text-center mb-12">
            <div className="text-primary text-[48px] max-lg:text-[36px] max-md:text-[28px] font-clashDisplay font-bold mb-4">
              The Most Future-Friendly Web Designing & Development Services
            </div>
            <div className="text-white text-[24px] max-lg:text-[20px] max-md:text-[18px] font-satoshi italic">
              Websites are the core of your business operations and brand image. At Marketing Reform, we understand the nuance and work on creating a web solution that grows with you. Our web solutions are designed with a customized approach and future-friendly infrastructure, so your website can integrate newer technologies and API’s needed to support your growth and rising demand!"
            </div>
          </div>
        </div>
      </div>
      ...
      <div className="relative pb-16 overflow-hidden">
        ...
        <div className="container relative z-20 px-4">
          <div className="text-primary text-center text-[48px] max-lg:text-[36px] max-md:text-[28px] font-clashDisplay font-bold mb-2">
            Our Dynamic Web-Development Services
          </div>
          <div className="text-white pb-6 text-center text-[24px] max-lg:text-[20px] max-md:text-[18px] font-satoshi italic">
